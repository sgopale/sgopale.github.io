...
Let's try a manual eval to get a flavor of things. The agent that we built in the post [Building a Coding Agent : Part 9 - Adding Command Handling](09-handling-input.html) will be used for this.
